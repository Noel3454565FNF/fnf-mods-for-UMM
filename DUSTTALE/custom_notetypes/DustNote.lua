function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'DustNote' then
			setPropertyFromGroup('unspawnNotes', i, 'texture', 'NOTE_assets_Dust'); --Change texture
...
function goodNoteHit(id, noteData, noteType, isSustainNote)
	if noteType == 'DustNote' then
		playSound('dust', true);
		makeLuaSprite('image', 'Dust_image', -500, -200);
