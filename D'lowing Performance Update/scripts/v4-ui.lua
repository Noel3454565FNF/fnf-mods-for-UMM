...
local offsetY = 188
local objWidth = 320
local creatorRare = "Composers: Rareblin, Pogo"
local creatorCval = "Composers: Cval, Pogo"
local creatorQuik = "Composers: Quik06, Pogo"
local creatorRoze = "Composers: Rozebud, Pogo"
local creatorCvalDeepFried = "Composers: Cval, DeepFriedBolonese, Pogo"
...
function onCreatePost()
	...
	if (songName == "D'lowing" or "Yarlow") then
	...
	if (songName == "Lemon Lime") then
	setTextString("botplayTxt", "haha fooled ya bitch")
	elseif downScroll then
		setProperty("botplayTxt.y", getProperty("healthBar.y")+40)
	else
		setProperty("botplayTxt.y", getProperty("healthBar.y")-60)
	...
	makeGraphic('creditBox', objWidth, 107, 'FFFFFF')
	...
	makeLuaText('creditCreator', creatorRare, objWidth, offsetX - objWidth, offsetY+41)
	setTextFont('creditCreator', 'arial-v4.ttf')
	setTextSize('creditCreator', 24)
	...
	if (songName == "Blackout") then
	makeLuaText('creditCreator', creatorCvalDeepFried, objWidth, offsetX - objWidth, offsetY+41)
	setTextFont('creditCreator', 'arial-v4.ttf')
	setTextSize('creditCreator', 24)
	setTextBorder('creditCreator', 1, '000000')
	setTextAlignment('creditCreator', 'left')
	...
	if (songName == "Monsters") then
	makeLuaText('creditCreator', creatorQuik, objWidth, offsetX - objWidth, offsetY+41)
	setTextFont('creditCreator', 'arial-v4.ttf')
	setTextSize('creditCreator', 24)
	setTextBorder('creditCreator', 1, '000000')
	setTextAlignment('creditCreator', 'left')
	...
	if (songName == "Lemon Lime") then
	makeLuaText('creditCreator', creatorRoze, objWidth, offsetX - objWidth, offsetY+41)
	setTextFont('creditCreator', 'arial-v4.ttf')
	setTextSize('creditCreator', 24)
	setTextBorder('creditCreator', 1, '000000')
	setTextAlignment('creditCreator', 'left')
