function onCreatePost()
  makeLuaText('credits1', 'Sprites: Cooldudecrafter', 0, getProperty('timeBar.x') + 10 , -100);
   ...
   makeLuaText('credits2', 'Remix Composer: GamerZone', 0, getProperty('timeBar.x') + 10 , -100);
   addLuaText('credits2')
   ...
   makeLuaText('credits4', 'Charters: Charaster + Cooldudecrafter', 0, getProperty('timeBar.x') + 10 , -100);
   addLuaText('credits4')
