...
if n == 'Opponent Two' and v1 == '1' then
setProperty('iconP2.visible', false)
setProperty('icon3.alpha', 1)
setProperty('icon4.visible', false)
setHealthBarColors("140115", "31b0d1") 
end
if n == 'Opponent Two' and v1 == '0' then
setProperty('iconP2.visible', true)
setProperty('icon3.alpha', 0)
setProperty('icon4.visible', false)
setHealthBarColors("FFFFFF", "31b0d1")
end
if n == 'Both Opponents' and v1 == '1' then
setProperty('iconP2.visible', false)
setProperty('icon3.alpha', 0)
setProperty('icon4.visible', true)
setHealthBarColors("736a87", "31b0d1")
end
end
function onCreate()
	if not hideHud then
	makeAnimatedLuaSprite('icon3', nil, getProperty('iconP2.x'), getProperty('iconP2.y'))
	loadGraphic('icon3', 'icons/icon-v2blackgoofy', 150)
	addAnimation('icon3', 'icons/icon-v2blackgoofy', {0, 1}, 0, true)
	addAnimation('icon3', 'icons/icon-v2blackgoofy', {1, 0}, 0, true)
	...
	loadGraphic('icon4', 'icons/icon-doublekill', 150)
	addAnimation('icon4', 'icons/icon-doublekill', {0, 1}, 0, true)
	addAnimation('icon4', 'icons/icon-doublekill', {1, 0}, 0, true)
