function onCreate()
    ...
    makeLuaSprite('polus', 'Sus/Polus', -800, -400);
...
function onUpdate()
    ...
    setProperty('scoreTxt.color', getColorFromHex('ea2300'))
    setProperty('timeTxt.color', getColorFromHex('ea2300'))
    setProperty('credits1.color', getColorFromHex('ea2300'))
    setProperty('credits2.color', getColorFromHex('ea2300'))
    setProperty('credits3.color', getColorFromHex('ea2300'))
    setProperty('credits4.color', getColorFromHex('ea2300'))
